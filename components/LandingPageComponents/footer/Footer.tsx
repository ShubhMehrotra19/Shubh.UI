    ...
    <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
       <Link href='https://shubh-ui.vercel.app/'><Image className='cursor-pointer active:scale-95 transition-all duration-300 ease-in-out' src={logo} alt='logo' width={100} height={40} /></Link>
        ...
        <span className="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
            ...
            <a href="https://www.instagram.com/who.isshubh/" className="text-gray-400 hover:text-gray-500">
            ...
            <Link href="https://twitter.com/ShubhMehro40210" className="text-gray-400 hover:text-gray-500">
