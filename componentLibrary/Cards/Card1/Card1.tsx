...
function Card1(props: Props) {
    ...
    return (
        ...
        <div className='flex flex-col justify-start items-start gap-3 rounded-md bg-slate-700 p-2 border-2 cursor-pointer'>
            ...
            <Image src='https://images.pexels.com/photos/22858523/pexels-photo-22858523/free-photo-of-s-curve-chicago.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load' alt='' height={300} width={300} className='h-[300px] w-[300px] rounded-md hover:scale-95' />
        </div>
        </>
    )
}
