...
function Button3_text(props: Props) {
    const {} = props;

    const code = `
// This component is still under construction due to some GSAP Placement issues. It should work fine in a normal React project.
